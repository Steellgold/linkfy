<script lang="ts">
  ...
  let errors = clsx({
    ...
    "Sorry but the required data sent does not correspond to the expectations of the request": error.code === 417,
...
<div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
  <div class="mx-auto max-w-screen-sm text-center">
    ...
    <p class="mb-4 text-lg font-sans text-gray-500 dark:text-gray-400">{ errors }</p>
