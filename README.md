...
Linkfy is an easy to use link shortner tool built using Sveletejs. [Learn More about Sveltejs](https://github.com/topics/sveltejs)
...
Use the package manager [npm](https://docs.npmjs.com/) to install the project's dependenices. This project uses ts-node. 
...
## Useful Links
* [Learn More about Sveltejs](https://github.com/topics/sveltejs)
